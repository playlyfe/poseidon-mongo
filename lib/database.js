...
Database.prototype.collectionNames = function () {
    var args = arguments;
    var deferred = Promise.pending();
    this.instance.catch(function (err) {
        deferred.reject(err);
        ...
        switch (args.length) {
        case 0:
            instanceValue.collectionNames(callback);
            break;
        case 1:
            instanceValue.collectionNames(args[0], callback);
            break;
        case 2:
            instanceValue.collectionNames(args[0], args[1], callback);
            break;
        case 3:
            instanceValue.collectionNames(args[0], args[1], args[2], callback);
            break;
        case 4:
            instanceValue.collectionNames(args[0], args[1], args[2], args[3], callback);
            break;
        case 5:
            instanceValue.collectionNames(args[0], args[1], args[2], args[3], args[4], callback);
            break;
        default:
            instanceValue.collectionNames.apply(instanceValue, Array.prototype.slice.call(null, args).concat(callback));
            break;
        }
    });
    return deferred.promise;
...
Database.prototype.dereference = function () {
    var args = arguments;
    var deferred = Promise.pending();
    this.instance.catch(function (err) {
        deferred.reject(err);
        ...
        switch (args.length) {
        case 0:
            instanceValue.dereference(callback);
            break;
        case 1:
            instanceValue.dereference(args[0], callback);
            break;
        case 2:
            instanceValue.dereference(args[0], args[1], callback);
            break;
        case 3:
            instanceValue.dereference(args[0], args[1], args[2], callback);
            break;
        case 4:
            instanceValue.dereference(args[0], args[1], args[2], args[3], callback);
            break;
        case 5:
            instanceValue.dereference(args[0], args[1], args[2], args[3], args[4], callback);
            break;
        default:
            instanceValue.dereference.apply(instanceValue, Array.prototype.slice.call(null, args).concat(callback));
            break;
        }
    });
    return deferred.promise;
...
Database.prototype.collectionsInfo = function () {
    var args = arguments;
    var deferred = Promise.pending();
    this.instance.catch(function (err) {
        deferred.reject(err);
        ...
        var callback = function () {
            if (arguments[0]) {
                ...
                arguments[1] = new Cursor(arguments[1]);
                switch (arguments.length) {
                case 0:
                    deferred.resolve();
                    break;
        ...
        switch (args.length) {
        case 0:
            instanceValue.collectionsInfo(callback);
            break;
        case 1:
            instanceValue.collectionsInfo(args[0], callback);
            break;
        case 2:
            instanceValue.collectionsInfo(args[0], args[1], callback);
            break;
        case 3:
            instanceValue.collectionsInfo(args[0], args[1], args[2], callback);
            break;
        case 4:
            instanceValue.collectionsInfo(args[0], args[1], args[2], args[3], callback);
            break;
        case 5:
            instanceValue.collectionsInfo(args[0], args[1], args[2], args[3], args[4], callback);
            break;
        default:
            instanceValue.collectionsInfo.apply(instanceValue, Array.prototype.slice.call(null, args).concat(callback));
            break;
        }
    });
    return deferred.promise;
